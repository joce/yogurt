...
`yogurt quote-summary` passes the `--modules` value through to Yahoo Finance's
`/v10/finance/quoteSummary/{symbol}` endpoint. Yogurt does not validate module
...
Yogurt probes against Yahoo's raw quote summary endpoint. Equity probes used
